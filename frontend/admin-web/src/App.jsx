...
import RecipesPage from "./pages/manager/RecipesPage";
...
const DashboardContent = () => {
  ...
  return (
    ...
    >
      ...
      {user.store && (
        <p>
          <strong>Cửa hàng:</strong> {user.store.name}
        </p>
      )}
      {user.warehouse && (
        <p>
          <strong>Kho/Bếp:</strong> {user.warehouse.name}
        </p>
      )}
    </div>
  );
...
const BREADCRUMB_MAP = {
  "/": ["Dashboard"],
  "/admin/overview": ["Admin", "Tổng quan hệ thống"],
...
function MainLayout() {
  ...
  const adminSubItems = [
    ...
    },
    {
      key: "/admin/users",
      icon: <TeamOutlined />,
      label: <Link to="/admin/users">Ngườii dùng</Link>,
    },
    {
      key: "/admin/stores",
      icon: <ShopOutlined />,
      label: <Link to="/admin/stores">Cửa hàng</Link>,
    },
    {
      key: "/admin/kitchens",
      icon: <HomeOutlined />,
      label: <Link to="/admin/kitchens">Bếp Trung Tâm</Link>,
    },
    {
      key: "/admin/config",
      icon: <SettingOutlined />,
      label: <Link to="/admin/config">Cấu hình</Link>,
    },
  ];
  ...
  const managerSubItems = [
    ...
    },
    {
      ...
      label: <Link to="/manager/items">Hàng hóa</Link>,
    },
    {
      key: "/manager/recipes",
      icon: <FileTextOutlined />,
      label: <Link to="/manager/recipes">Công thức</Link>,
    },
    {
    ...
    {
      key: "/manager/store-inventory",
      icon: <ShopOutlined />,
      label: <Link to="/manager/store-inventory">Tồn kho Cửa hàng</Link>,
    },
    {
      key: "/manager/orders",
      icon: <FileTextOutlined />,
      label: <Link to="/manager/orders">Đơn hàng từ cửa hàng</Link>,
    },
  ];
            ...
            children: [
              {
                key: "/supply",
                icon: <DashboardOutlined />,
                label: <Link to="/supply">Tổng quan</Link>,
              },
              {
                key: "/supply/orders",
                icon: <FileTextOutlined />,
                label: <Link to="/supply/orders">Duyệt đơn hàng</Link>,
              },
              {
                key: "/supply/summary",
                icon: <BarChartOutlined />,
                label: <Link to="/supply/summary">Tổng hợp nhu cầu</Link>,
              },
              {
                key: "/supply/delivery/schedule",
                icon: <CarOutlined />,
                label: (
                  <Link to="/supply/delivery/schedule">Lập lịch giao hàng</Link>
                ),
              },
              {
                key: "/supply/delivery/tracking",
                icon: <CarOutlined />,
                label: (
                  <Link to="/supply/delivery/tracking">Theo dõi tiến độ</Link>
                ),
              },
            ],
          },
            ...
            children: [
              {
                key: "/kitchen",
                icon: <DashboardOutlined />,
                label: <Link to="/kitchen">Tổng quan</Link>,
              },
              {
                key: "/kitchen/orders",
                icon: <FileTextOutlined />,
                label: <Link to="/kitchen/orders">Danh sách đơn</Link>,
              },
              {
            ...
            children: [
              {
                key: "/store",
                icon: <HomeOutlined />,
                label: <Link to="/store">Tổng quan</Link>,
              },
              {
                key: "/store/orders",
                icon: <FileTextOutlined />,
                label: <Link to="/store/orders">Đơn hàng</Link>,
              },
              {
                key: "/store/orders/new",
                icon: <FileTextOutlined />,
                label: <Link to="/store/orders/new">Tạo đơn hàng</Link>,
              },
            ],
          },
        ]
      ...
      <Layout>
        ...
        >
          <Space>
            ...
            />
            <Breadcrumb
              items={breadcrumbs.map((b, i) => ({ title: b, key: i }))}
            />
          </Space>
          <Space>
        ...
        >
          CNPM_CS3 — Central Kitchen & Franchise Store Management ©
      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={
              <ProtectedRoute
                allowedRoles={["SUPPLY_COORDINATOR", "MANAGER", "ADMIN"]}
              >
          ...
          <Route
            ...
            element={
              <ProtectedRoute
                allowedRoles={["SUPPLY_COORDINATOR", "MANAGER", "ADMIN"]}
              >
                <CoordinatorSummaryPage />
              </ProtectedRoute>
            }
          />
          <Route
            path="supply/delivery/schedule"
            element={
              <ProtectedRoute
                allowedRoles={["SUPPLY_COORDINATOR", "MANAGER", "ADMIN"]}
              >
                <CoordinatorDeliverySchedulePage />
              </ProtectedRoute>
            }
          />
          <Route
            path="supply/delivery/tracking"
            element={
              <ProtectedRoute
                allowedRoles={["SUPPLY_COORDINATOR", "MANAGER", "ADMIN"]}
              >
                <CoordinatorDeliveryTrackingPage />
              </ProtectedRoute>
            }
          />
          <Route
